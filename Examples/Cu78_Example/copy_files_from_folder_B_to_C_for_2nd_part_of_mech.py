...
adsorbates_info = {}
adsorbates_info['CH2O'] = [top_sites,bridge_sites,{}]
adsorbates_info['CHOH'] = [{},bridge_sites,{}]
adsorbates_info['CH3O'] = [{},{},three_fold_sites]
adsorbates_info['CH2OH'] = [top_sites,{},{}]

adsorbates_info['CH3'] = [top_sites,bridge_sites,{}]
adsorbates_info['CH2'] = adsorbates_info['CH'] = [{},bridge_sites,three_fold_sites]
adsorbates_info['C'] = [{},bridge_sites,three_fold_sites]

adsorbates_info['OH'] = [{},bridge_sites,three_fold_sites]
adsorbates_info['O']  = [{},{},three_fold_sites]

for adsorbate, (top_sites, bridge_sites, three_fold_sites) in adsorbates_info.items():
