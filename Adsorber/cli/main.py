...
commands = [
    ('PartA',                           'Adsorber.Adsorber.Run_PartA'),
    ('PartB',                           'Adsorber.Adsorber.Run_PartB'),
    ('PartC',                           'Adsorber.Adsorber.Run_PartC'),
    ('check_submit',                    'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_only_show_submitSL_slurm'),
    ('submit',                          'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_submitSL_slurm'),
    ('check_unconverged',               'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_determine_unconverged_VASP_jobs'),
    ('prep_single_resub',               'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_single_prep_for_resubmission'),
    ('repeat',                          'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_repeat_current_job'),
    ('prep_and_repeat',                 'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_prep_and_repeat'),
    ('PartD',                           'Adsorber.Adsorber.Run_PartD'),
    ('compare',                         'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_compare_systems_with_same_binding'),
    ('tidy',                            'Adsorber.Subsidiary_Programs_through_cli.Run_Adsorber_Tidy_Finished_Jobs'),
]

def main(prog='Adsorber', description='Adsorber command line tool.',version=__version__, commands=commands, hook=None, args=None):
