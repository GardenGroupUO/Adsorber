...
def write_meta_YAML(version):
  ...
  with open(name_of_file,'w') as metaYAML:
    ...
    metaYAML.write('  name: adsorber\n')
    metaYAML.write('  version: {{ version }}\n')
    metaYAML.write('\n')
    metaYAML.write('source:\n')
    metaYAML.write('  git_rev: {{ version }}\n')
    metaYAML.write('  git_url: https://github.com/GardenGroupUO/Adsorber.git\n')
    metaYAML.write('\n')
    ...
    metaYAML.write('  home: https://github.com/GardenGroupUO/Adsorber\n')
    metaYAML.write('  license: AGPL-3.0\n')
    metaYAML.write('  summary: "The Adsorber Program is designed to provide models of molecules adsorbed to all possible sites on a cluster."\n')
    metaYAML.write('\n')
