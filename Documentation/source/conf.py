...
latex_documents = [
    (master_doc, 'Adsorber.tex', u'The Adsorber Documentation',
...
man_pages = [
    (master_doc, 'Adsorber', u'The Adsorber Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Adsorber', u'The Adsorber Documentation',
     author, 'Adsorber', 'This program is designed to adsorb molecules in various way to the surface of a cluster or a surface. This program adsorbed molecules ontop of atoms, ontop of bridge sites, ontop of three-fold sites, and ontop of four fold sites.',
     'Research'),
]
